...
pub fn register_stdlib(registry: &mut PluginRegistry) {
    ...
    registry.register_comparator("binoc.binary", Arc::new(comparators::binary::BinaryComparator));

    registry.register_transformer("binoc.move_detector", Arc::new(transformers::move_detector::MoveDetector));
    registry.register_transformer("binoc.copy_detector", Arc::new(transformers::copy_detector::CopyDetector));
    registry.register_transformer("binoc.column_reorder_detector", Arc::new(transformers::column_reorder::ColumnReorderDetector));
